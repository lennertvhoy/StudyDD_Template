...
Ask for feedback in these situations:

- After several sessions have accumulated.
- After repeated misses on the same skill or topic.
- After repeated learner overrides of agent recommendations.
- After low engagement (short answers, skipped questions, delayed responses).
- After completing a target milestone.

Do not ask for feedback during every ordinary question.
