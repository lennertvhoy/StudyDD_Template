...
def main() -> int:
    ...
    required_transcript_fragments = [
        ...
        "Validation passed",
        "not only a question generator",
        "outside the chat",
        "completed the activity",
        "submitted the result",
        "reviewed the submitted evidence",
        "StudyDD keeps source freshness strict for product-current questions",
        "This development scenario is conceptual practice and uses an explicit logical clock",
        "The agent does not treat fixture metadata as a live source refresh",
        "A product-current question would require a fresh source at its actual evaluation time",
        "StudyDD suggestion:",
