...
- `EXAMPLES/product-engineer-interview-example/` — a concrete interview prep example
...
v0.2 — agent-native template with AI-103 and product-engineer interview examples, expanded agent guidance, and stronger validation.
