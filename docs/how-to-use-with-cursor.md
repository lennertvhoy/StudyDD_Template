# How To Use StudyState With Cursor

## Setup

1. Clone or copy the StudyState Template repository (`StudyDD_Template`) into a folder.
...
Initialize this StudyState copy for me. I want to build a study plan for a course. Ask only the essential setup questions first.
```
