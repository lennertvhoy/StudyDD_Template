# StudyState — LinkedIn Product Blurb

Use this short text when sharing StudyState publicly.

---

## Short version

**StudyState** is a GitHub-template study system that turns a coding agent into a disciplined tutor, while the repo remains the source of truth.

Serious learning should have state.

StudyState keeps skills, readiness, evidence, spaced-repetition reviews, and next actions in plain Markdown and YAML files — not inside a chat history or a proprietary database.
...
**StudyState** fixes that by making learning state explicit and auditable. It is a GitHub template that turns a coding agent into a disciplined tutor:
